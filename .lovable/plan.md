...
- `src/routes/admin/nastavenia.tsx`: odstrániť záložku Shopify, `ShopifyCard`, stavy secrets (SHOPIFY\_\*), webhook URL blok a zmienky v podtituloch; WordPress sa stane predvolenou záložkou.
